                    ...
                    <div class="p-4 sm:p-7">
                        ...
                        <form wire:submit.prevent="save">
                            <div class="grid gap-y-4">
                                ...
                                <button type="submit"
                                    class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"><span wire:loading.remove wire:target='save'>Sign Up</span><span wire:loading wire:target='save'><div class="border-gray-300 h-4 w-4 animate-spin rounded-full border-2 border-t-blue-600" /></span></button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
