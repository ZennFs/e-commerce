            ...
            <div class="relative md:flex md:items-center md:justify-between">
                <div class="flex items-center justify-between">
                    <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/" aria-label="Brand">E-Thrifting</a>
                    <div class="md:hidden">
                        <button type="button"
                ...
                <div id="navbar-collapse-with-animation"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a  class="font-medium {{ request()->is('url', '/') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 hover:text-gray-400'}}  py-3 md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/" aria-current="page" wire:navigate>Home</a>

                            <a  class="font-medium {{ request()->is('url', 'categories') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 hover:text-gray-400'}}  py-3 md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/categories" wire:navigate>
                                Categories
                            </a>

                            <a  class="font-medium {{ request()->is('url', 'products') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 hover:text-gray-400'}}  py-3 md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/products" wire:navigate>
                                Products
                            </a>

                            <a  class="font-medium flex items-center {{ request()->is('url', 'cart') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 hover:text-gray-400'}}  py-3 md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
