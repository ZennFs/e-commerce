                ...
                <div
                    ...
                    <div class="p-4 sm:p-7">
                        <div class="text-center">
                            <h1 class="block text-xl font-bold text-gray-800 dark:text-white">Reset password</h1>
                        </div>
                            ...
                            <form wire:submit.prevent="save">
                                ...
                                <div class="grid gap-y-4">
                                    ...
                                    <button type="submit"
                                        ...
                                        <span wire:loading.remove wire:target='save'>Save Password</span><span wire:loading wire:target='save'><div class="border-gray-300 h-4 w-4 animate-spin rounded-full border-2 border-t-blue-600" /></span>
                                    </button>
                                </div>
                            </form>
                            <!-- End Form -->
