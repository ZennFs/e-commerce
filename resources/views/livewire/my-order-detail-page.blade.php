            ...
            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
                <div class="p-4 md:p-5 flex gap-x-4">
                    ...
                    if ($order->payment_status == 'paid') {
                        $payment_status ='<span class=" bg-green-500 text-white py-1 px-3  rounded-md shadow">Paid</span>';
                    }
                    if ($order->payment_status == 'pending') {
                       $payment_status ='<span class="bg-blue-500 text-white py-1 px-3  rounded-md shadow">Pending</span>';
                    }
                    if ($order->payment_status == 'failed') {
                       $payment_status ='<span class=" bg-red-500 text-white py-1 px-3  rounded-md shadow">Failed</span>';
                    }
                    @endphp
                    <div class="grow">
                        <div class="flex items-center gap-x-2">
