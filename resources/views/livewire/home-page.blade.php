<div>
    <div class="w-full h-screen bg-gradient-to-r from-sky-200 to-blue-300 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-5xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">E-Thrifting</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase wide varities of all products like Fashion, Electronic, Laptop, Gadget and many more.</p>
      ...
      <section class="py-20 bg-neutral-50 dark:bg-gray-800 ">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> Browse Popular<span class="text-sky-500"> Brands
                </span> </h1>
              <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                <div class="flex-1 h-2 bg-sky-200">
                </div>
                <div class="flex-1 h-2 bg-sky-400">
                </div>
                <div class="flex-1 h-2 bg-sky-600">
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{$brand->id}}">
              <a href="/products?selected_brands[0]={{$brand->id}}" class="">
                <img src="{{ URL::asset('storage/'.$brand->image) }}" alt="{{$brand->name}}" class="object-cover w-full h-64 rounded-t-lg">
              </a>
      ...
      <div class="bg-sky-300 py-20">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold text-white dark:text-gray-200"> Browse <span class="text-sky-500"> Categories
                </span> </h1>
              <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                <div class="flex-1 h-2 bg-sky-200">
                </div>
            ...
            <p class="mb-12 text-base text-center text-gray-900">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus magni eius eaque?
              Pariatur
              numquam, odio quod nobis ipsum ex cupiditate?
            </p>
              ...
              <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                  <div class="flex items-center">
                    <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ URL::asset('storage/'.$category->image) }}" alt="{{$category->name}}">
                    <div class="ms-3">
      ...
      <section class="py-14 font-poppins bg-neutral-50 dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold  dark:text-slate-200"> Customer <span class="text-sky-500"> Reviews
                  </span> </h1>
                <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                  <div class="flex-1 h-2 bg-sky-200">
                  </div>
